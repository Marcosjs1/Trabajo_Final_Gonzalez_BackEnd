...
public class OrdenCompraDetalleController extends BaseController<OrdenCompraDetalle, UUID>{
    ...
    public Optional<OrdenCompraDetalle> agregarOrdenCompra (@RequestBody OrdenCompra ordenCompra, @PathVariable UUID idOrdenCompraDetalle) throws Exception{
    ...
    public Optional<OrdenCompraDetalle> agregarProducto (@RequestBody Producto producto, @PathVariable UUID idOrdenCompraDetalle) throws Exception{
    ...
    public ResponseEntity<List<OrdenCompraDetalle>> listarPorOrdenCompra(@PathVariable UUID id) throws Exception{
    ...
    public ResponseEntity<List<OrdenCompraDetalle>>listarPorProducto(@PathVariable UUID id) throws Exception{
